...
#    fileNames = cms.untracked.vstring('/store/user/nsahoo/MuOnia/Onia2MuMuPAT-Run2015B-MuOnia-v1/150727_073035/0000/Onia2MuMuPAT-Run2015B_102.root')
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/n/nsahoo/Run2-TRG-study/CMSSW_7_4_7_patch2/src/HeavyFlavorAnalysis/Skimming/test/Onia2MuMuPAT-mc.root')

)

process.TFileService = cms.Service("TFileService",
        fileName = cms.string('Onia2MuMuRootuple-mc.root'),
)
...
process.rootuple.isMC = cms.bool(True)                 # is mc?
